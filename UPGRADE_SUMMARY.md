...
- [x] ℹ️  Kept 9 v0.5.0 example files (still referenced in Google Sheet)
- [x]   • components/texts/stories/story2/step3-layer1.md
- [x]   • components/structures/story-1.csv
- [x]   • components/texts/stories/story2/step1-layer1.md
- [x]   • components/texts/stories/story2/step5-layer1.md
- [x]   • components/texts/stories/story2/step10-layer1.md
- [x]   ... and 4 more
- [x] ✓ Removed 2 v0.5.0 example files (not in use)
